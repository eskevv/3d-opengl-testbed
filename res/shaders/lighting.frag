...
void main()
{
    ...
    vec3 diffuse = light.diffuse * diffuseAngle * diffuseMap * attenuation * intensity;
    ...
    vec3 specular = light.specular * shininess * specularMap * attenuation * intensity;
    ...
    vec3 emission = emissionCoords * emissiveness * attenuation * intensity;
